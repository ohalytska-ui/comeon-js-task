export const players = {
  ...
  stoffe: {
    name: 'Stoffe Rocker',
    avatar: 'assets/avatar/stoffe.jpg',
...
export const games = [
  {
    ...
    code: 'feastingfox',
    icon: 'assets/game-icon/feasting_fox.png',
    categoryIds: [0, 2],
  },
  {
    ...
    icon: 'assets/game-icon/book_of_inferno_logo.png',
    categoryIds: [0, 1],
  },
  {
    name: 'Warp Wreckers',
    ...
    code: 'warpwreckers',
    icon: 'assets/game-icon/warp_wreckers_powerglyph_logo.png',
    categoryIds: [0, 2, 1],
  },
  {
    name: "Reno 7's",
    ...
    code: 'renosevens',
    icon: 'assets/game-icon/renoseverns_logo_one_line_shadow.png',
    categoryIds: [0, 2],
  },
  {
    ...
    icon: 'assets/game-icon/scatter-monster-logo.png',
    categoryIds: [0, 1],
  },
];
